...
kpi1_all_barplot_bdr = px.bar(df_aggregated_t1_BDR, x='BDR Name', y='VISITED_STORES', color_discrete_sequence=['#203e5f'])
...
kpi1_all_barplot_bdr_mtd = px.bar(df_tf_mtd_agg, x='BDR Name', y='VISITED_STORES', color_discrete_sequence=['#203e5f'])
...
kpi2_all_barplot_bdr = px.bar(df_aggregated_t2_BDR_sorted, x='BDR Name', y='count_registered_stores', color_discrete_sequence=['#203e5f'])
...
kpi2_all_barplot_bdr_mtd = px.bar(df_tf2_mtd_agg, x='BDR Name', y='count_registered_stores', color_discrete_sequence=['#203e5f'])
formatted_max_date_t2 = max_date_t2.strftime('%Y-%m-%d')
...
kpi3_all_barplot_bdr = px.bar(df_t3_agg_bees_sort, x='BDR Name', y='TOTAL_ORDERS', color_discrete_sequence=['#203e5f'])
...
kpi3_all_barplot_bdr_mtd = px.bar(df_t3_mtd_agg, x='BDR Name', y='TOTAL_ORDERS', color_discrete_sequence=['#203e5f'])
...
kpi4_all_barplot_bdr = px.bar(df_t3_sales_notnull_sort, x='BDR Name', y='TOTAL_SALES', color_discrete_sequence=['#203e5f'], text=formatted_sales)
